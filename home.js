...
// const options = document.querySelectorAll(".opt_a");
// const h3s = document.querySelectorAll('.hr3');
// const h4s = document.querySelectorAll('h4');
// const f_as = document.querySelectorAll('.f_a');
...
label5.onclick = function(){
        ...
        opt5.innerText = `Маскитные сетки`;
    
        h1.innerText = `Крыши`;
        h2.innerText = `Тенты`;
        h3.innerText = `Жалюзи`;
        h4.innerText = `Складные окна`;
        h5.innerText = `Маскитные сетки`;
